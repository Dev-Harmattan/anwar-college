...
const dbUrl = `mongodb+srv://${DBUSER}:${DBPASSWORD}@cluster0.bbitn.mongodb.net/anwar?retryWrites=true&w=majority`;
mongoose.connect(
  dbUrl,
...
app.use(session({
    ...
    store: MongoStore.create({ 
        mongoUrl: `mongodb+srv://${DBUSER}:${DBPASSWORD}@cluster0.bbitn.mongodb.net/anwar?retryWrites=true&w=majority`,
        autoRemove: 'disabled'
     }),
    resave: false,
